          ...
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <div className="py-2">
                ...
                <Input placeholder="Ex. Mohammed Al-helali" {...register('name',{required:true})}></Input>
              ...
              <div className="py-2">
                ...
                <Input type="number" placeholder="Ex. 4894231747" {...register('contact',{required:true})}></Input>

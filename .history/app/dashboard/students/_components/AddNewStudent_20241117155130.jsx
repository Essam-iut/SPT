          ...
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <>
                ...
                <option value={"Grade 6th"}>Grade 6<sup>th</sup></option>
                <option value={"Grade 7th"}>Grade 7<sup>th</sup></option>
                <option value={"Grade 8th"}>Grade 8<sup>th</sup></option>
                <option value={"Grade 9th"}>Grade 9<sup>th</sup></option>
                <option value={"Grade 10th"}>Grade 10<sup>th</sup></option>
                <option value={"Grade 11th"}>Grade 11<sup>th</sup></option>
